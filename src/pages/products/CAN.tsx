...
export function CAN() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background pt-20">
      <section className="pt-12 pb-24 md:pt-16 md:pb-32">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="prose prose-lg prose-invert text-text-muted mb-8">
                <p className="text-xl leading-relaxed text-text">
                  Provides stable nitrogen supply with added calcium for improved plant and soil performance.
                </p>
              </div>

              <Button size="lg" onClick={() => navigate('/contact', { state: { product: 'CAN Fertilizer' } })} className="group">
                Request CAN Pricing
            ...
            >
              <img
                src="https://i.postimg.cc/ZRJFg24b/CAN.jpg"
                alt="CAN Fertilizer"
      ...
      <ProductSections productName="CAN fertilizer [Calcium Ammonium Nitrate]" />
    </div>
  );
}

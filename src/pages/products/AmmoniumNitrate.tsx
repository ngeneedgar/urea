  ...
  return (
    <div className="flex flex-col min-h-screen bg-background pt-20">
      <SEO 
        ...
        description="Fast-acting nitrogen fertilizer designed for rapid crop response and efficient nutrient absorption. Request wholesale pricing."
        url="https://novaferti.com/products/ammonium-nitrate"
      />
      <section className="pt-12 pb-24 md:pt-16 md:pb-32">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="prose prose-lg prose-invert text-text-muted mb-8">
                <p className="text-xl leading-relaxed text-text">
                  Fast-acting nitrogen fertilizer designed for rapid crop response and efficient nutrient absorption.
                </p>
              </div>

              <Button size="lg" onClick={() => navigate('/contact', { state: { product: 'Ammonium Nitrate Fertilizer' } })} className="group">
                Request Pricing
            ...
            >
              <img
                src="https://i.postimg.cc/qRpXYS47/ammonium-nitrate-11.webp"
                alt="Ammonium Nitrate Fertilizer"
      ...
      <ProductSections productName="Ammonium nitrate Fertilizer" />
    </div>
  );
}

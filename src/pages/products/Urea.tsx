  ...
  return (
    <div className="flex flex-col min-h-screen bg-background pt-20">
      <SEO 
        ...
        description="High nitrogen fertilizer widely used for strong plant growth and yield improvement. Granular and Prilled available. Request bulk Urea pricing."
        url="https://novaferti.com/products/urea"
      />

  ...
  return (
    <div className="flex flex-col min-h-screen bg-background pt-20">
      <SEO 
        ...
        description="Phosphorus-rich fertilizer that supports root development and early crop establishment. Request DAP bulk pricing."
        url="https://novaferti.com/products/dap"
      />
            ...
            >
              ...
              <div className="prose prose-lg prose-invert text-text-muted mb-8">
                <p className="text-xl leading-relaxed text-text">
                  Phosphorus-rich fertilizer that supports root development and early crop establishment.
                </p>
              </div>

              <Button size="lg" onClick={() => navigate('/contact', { state: { product: 'DAP Fertilizer' } })} className="group">
                Request DAP Pricing
      ...
      <ProductSections productName="DAP fertilizer [Diammonium Phosphate]" />
    </div>
  );
}

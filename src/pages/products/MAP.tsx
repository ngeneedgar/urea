  ...
  return (
    <div className="flex flex-col min-h-screen bg-background pt-20">
      <SEO 
        ...
        description="Efficient phosphorus source for early-stage growth and nutrient uptake. Request bulk supply and pricing today."
        url="https://novaferti.com/products/map"
      />
      <section className="pt-12 pb-24 md:pt-16 md:pb-32">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="prose prose-lg prose-invert text-text-muted mb-8">
                <p className="text-xl leading-relaxed text-text">
                  Efficient phosphorus source for early-stage growth and nutrient uptake.
                </p>
              </div>

              <Button size="lg" onClick={() => navigate('/contact', { state: { product: 'MAP Fertilizer' } })} className="group">
                Request MAP Pricing
            ...
            >
              <img
                src="https://i.postimg.cc/nznY5gps/MAP.jpg"
                alt="MAP Fertilizer"
      ...
      <ProductSections productName="MAP fertilizer [Monoammonium Phosphate]" />
    </div>
  );
}

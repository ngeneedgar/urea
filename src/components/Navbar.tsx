...
const navLinks = [
  ...
  { name: 'About', path: '/about' },
  {
    ...
    dropdown: [
      ...
      { name: 'DAP fertilizer [Diammonium Phosphate]', path: '/products/dap' },
      { name: 'MAP fertilizer [Monoammonium Phosphate]', path: '/products/map' },
      { name: 'CAN fertilizer [Calcium Ammonium Nitrate]', path: '/products/can' },
      { name: 'Ammonium nitrate Fertilizer', path: '/products/ammonium-nitrate' },
      { name: 'Potassium Chloride Fertilizer [Potash]', path: '/products/potash' },
    ],
  },
  { name: 'Blog', path: '/blog' },
